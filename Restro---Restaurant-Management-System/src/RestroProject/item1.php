...
<table>
    ...
    { ?>
        <tr>
            ...
            <td>
                <a href="menucard.php?edit=<?php echo $row['mid']; ?>" class="edit_btn" >Edit</a>
            </td>
            <td>
                <a href="menucard.php?del=<?php echo $row['mid']; ?>" class="del_btn">Delete</a>
            </td>
    ...
    <form method="post" action="menucard.php" >
